...
if (is_file($com_path . 'router.php')) { require_once $com_path . 'router.php'; }
if (is_file($com_path . 'helpers/route.php')) { require_once $com_path . 'helpers/route.php'; }
if (file_exists(JPATH_SITE . '/components/com_k2/helpers/route.php'))
   if (is_file(JPATH_SITE . '/components/com_k2/helpers/route.php')) { require_once JPATH_SITE . '/components/com_k2/helpers/route.php'; }

if (file_exists(JPATH_SITE . '/components/com_virtuemart/route.php'))
   if (is_file(JPATH_SITE . '/components/com_virtuemart/route.php')) { require_once JPATH_SITE . '/components/com_virtuemart/route.php'; }
...
function select($args) {
    ...
    function get_vm_Options($lang=false) {
        if (is_file(JPATH_ADMINISTRATOR . '/components/com_virtuemart/helpers/config.php')) { require_once JPATH_ADMINISTRATOR . '/components/com_virtuemart/helpers/config.php'; }
        $options = array();
        $jinput = JFactory::getApplication()->input;
        if(!$lang){
