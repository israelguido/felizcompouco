...
class DeleteMigratedArticlesCommand  extends AbstractCommand
{
     ...
     * @since  4.0.0
     */
    protected static $defaultName = 'delete:migrate:articles';
    ...
    protected function doExecute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->ioStyle->title('Qué artículos desea eliminar? wordpress o k2');
