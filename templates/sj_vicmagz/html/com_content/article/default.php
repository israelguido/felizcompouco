			...
			<aside class="article-aside">
				...
				<?php if ($params->get('show_category')) : ?>
					...
					<dd class="category-name">
						...
						<?php $catslug = !empty($this->item->catslug) ? $this->item->catslug : ($this->item->catid . (!empty($this->item->category_alias) ? ':' . $this->item->category_alias : '')); ?>
						<?php if ($params->get('link_category') && $catslug) : ?>
							<?php $url = '<a href="' . JRoute::_(ContentHelperRoute::getCategoryRoute($catslug)) . '" itemprop="genre">' . $title . '</a>'; ?>
			...
			<div class="article-info muted">
				...
				<?php if ($info == 1) : ?>
					...
					<?php if ($params->get('show_category')) : ?>
						<dd class="category-name">
							<?php 	$title = $this->escape($this->item->category_title);
							$catslug = !empty($this->item->catslug) ? $this->item->catslug : ($this->item->catid . (!empty($this->item->category_alias) ? ':' . $this->item->category_alias : ''));
