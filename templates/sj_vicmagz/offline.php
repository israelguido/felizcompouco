...
<body>
	<div id="yt-Page">
	    <div id="yt-PageTop">
			...
			?>
					<a class="logo" href="" title="<?php echo $app->get('sitename'); ?>">
						<img src="<?php echo $url; ?>" alt="<?php echo $app->get('sitename'); ?>"   />
					</a>
					<h3 class="text-logo"><?php echo $app->get('sitename'); ?></h3>
			<?php else : ?>
                      <a href="./" class="logo">
		...
		<div id="yt-PageWrap">     
		     ...
		     <div id="frame">
		            <p class="login-text"><?php echo $app->get('offline_message'); ?></p>
